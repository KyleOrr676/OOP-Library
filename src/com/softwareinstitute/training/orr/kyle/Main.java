...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Title (Novel) : "+ Novel.getTitle() +", this book's genre is:"+ Novel.getGenre()+ ", written by and " + Novel.getAuthor()+" is "+ Novel.getNovelLength()+ " pages long.");

        LibraryContents.add(new Comic("The Amazing Spider-man", "Superhero", "Stan Lee and Steve Ditko", 68));
        System.out.println("Title (Comic) : "+ Novel.getTitle() +", this comic's genre is: "+ Novel.getGenre()+ ", written by and " + Novel.getAuthor()+" is "+ Comic.getComicLength()+ "  pages long.");
    }
}